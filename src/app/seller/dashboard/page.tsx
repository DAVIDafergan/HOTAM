                                 ...
                                 <div className="p-6 md:p-8 grid md:grid-cols-2 gap-8">
                                    <div className="space-y-4">
                                       ...
                                       <div className="bg-white p-6 rounded-[2rem] border border-primary/5 space-y-3 shadow-sm">
                                          <div className="flex justify-between items-center"><span className="text-sm font-bold text-primary">{o.buyerName}</span><span className="text-[10px] text-muted-foreground font-black">שם מלא</span></div>
                                          <div className="flex justify-between items-center"><span className="text-sm font-bold text-primary">{o.buyerPhone}</span><span className="text-[10px] text-muted-foreground font-black">טלפון</span></div>
                                          <div className="flex justify-between items-center"><span className="text-sm font-bold text-primary">{o.buyerAddress}</span><span className="text-[10px] text-muted-foreground font-black">כתובת</span></div>
                                       </div>
                                    </div>
                                    <div className="space-y-4">
