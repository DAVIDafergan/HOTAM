  ...
  useEffect(() => {
    if (user && !isUserLoading && loading) {
      ...
      const sellerData = {
        ...
        hasScribeCertificate: formData.hasScribeCertificate,
        certificateUrl: formData.certificateUrl,
        torahStudyFrequency: formData.torahStudyFrequency,
        mikvehFrequency: formData.mikvehFrequency,
        notes: formData.notes,
        experienceYears: Number(formData.experienceYears),
        scriptLevel: formData.scriptLevel,
        scriptTypes: formData.scriptTypes,
