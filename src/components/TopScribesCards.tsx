          ...
          >
            <Link href={`/sellers/${scribe.id}`}>
              <Card className="group overflow-hidden border border-primary/5 shadow-premium rounded-[2.15rem] bg-white hover:-translate-y-1 transition-all duration-300 text-center p-5">
                ...
                <div className="mt-4">
                  <Button variant="outline" className="rounded-full w-full h-11 border-primary/10 text-[9px] font-bold uppercase tracking-wide group-hover:bg-accent group-hover:text-primary group-hover:border-accent transition-all">
